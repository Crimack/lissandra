...
class MatchAPI(KernelSource):
    ...
    _validate_get_match_query = Query.has("id").as_(int).also.has("platform").as_(Platform)
    ...
    _validate_get_many_match_query = Query.has("ids").as_(Iterable).also.has("platform").as_(Platform)
    ...
    _validate_get_timeline_query = Query.has("id").as_(int).also.has("platform").as_(Platform)
    ...
    _validate_get_many_timeline_query = Query.has("ids").as_(Iterable).also.has("platform").as_(Platform)
